...
public class MySQLChoreRepository implements ChoreRepository {
    ...
    private boolean connectToMySQL() {
        try {
            ...
            connection = DriverManager
                    .getConnection("jdbc:mysql://192.168.1.254:3306/db2022108035?user=user2022108035&password=2022108035");
            return Boolean.TRUE;
    ...
    public boolean update(Chore chore){
        if(Objects.isNull(chore)){
            throw new NullChoreException("Chore Object is null");
        }
        ...
        if(Objects.isNull(chore.getIsCompleted())){
            throw new NullIsCompletedException("isCompleted is null");
        }
